...
function POSOnlinePickupPage() {
    ...
    const handleProcessReturn = async (returnRequest, location)=>{
        await new Promise((resolve)=>setTimeout(resolve, 500));
        setOrders((prev)=>prev.map((order)=>order.id === returnRequest.orderId ? {
                    ...order,
                    status: "returned",
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Return Completed", {
...
//# sourceMappingURL=_92d74c3a._.js.map